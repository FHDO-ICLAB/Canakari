...
// Commentary   : Strukturorientiert, bis auf einige zusammengef�hrte resetsignale
...
wire        resetdstsig; 
wire        loader; 
wire [14:0] crc_pre_load_sig_ext;   // �nderung im crc
wire [14:0] crc_pre_load_sig_rem;   // �nderung im crc
...
wire        rrtr;          
wire        rmzero;        
// wire equal19, equal39;          // ersatz f�r rec_data_shifting
...
assign actvtsftsig  =  actvtsft | actvtsftllc;              // actvtsft aus llc und macfsm zusammenf�hren
assign resetsig     = sync_reset_i & resettra;              // reset aus mac_reset und llc zusammenf�hren
assign resetstfsig  = sync_reset_i & resettra & resetstf;   // reset aus mac_reset und llc und mac zusammenf�hren
assign rescountsig  = sync_reset_i & rescount;              // reset aus mac_reset und mac zusammenf�hren 
assign resrmlensig  = sync_reset_i & resrmlen;              // reset aus mac_reset und mac zusammenf�hren
assign resetdstsig  = sync_reset_i & resetdst;              // reset aus mac_reset und mac zusammenf�hren
assign outbit       = bitout;                               // Ausgabe
assign loader       = load | lmsg;                          // ladesignal f�r tshift aus macfsm und llc zusammenf�hren
