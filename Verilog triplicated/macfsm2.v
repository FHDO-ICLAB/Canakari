...
//                signalxx_set==2'b00; // Unver�ndert lassen;
//                signalxx_set="01"; 
...
module macfsm2(
	...
	input  wire Prescale_EN,    // DW 2005.06.30 Prescale Enable eingef�gt
...
wire [7:0] current_stateVoted = current_state;


assign statedeb = current_stateVoted;		// Debug signal
...
always@* /*(current_stateVoted, sendpoint, smplpoint, crc_ok, inbit, stufft, stuffr, biterror, stferror, trans, 
        ...
        if (stuffr == 1'b1 && stferror == 1'b0) 
          ...
          next_state <= rec_flglen_shiftdlc8;
               ...
               (inbit == 1'b0 ||
                (
                  count != 12 &&
                  count != 13 &&       //n�chste Zeile: "|| rrtr==1'b1" von mir
...
//�nderung: actvrcrc <= 1'b1 , dann wird crc ins empfangsregister nachgeschoben        
